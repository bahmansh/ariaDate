...
class AriaDate
{
   ...
   */
    ...
    function gregorian_to_jalali_main($g_y, $g_m, $g_d, $str = null)
    {
        ...
        if ($str == null) return $jy . '-' . $jms . '-' . $jds;
        else
            return $jy . $str . $jms . $str . $jds;

        return array($jy, $jm, $jd);
    }
    function get_current_jalali_date($str = null)
    {
    ...
    function jalali_to_gregorian_main($j_y, $j_m, $j_d, $str = null)
    {
        $g_days_in_month = array(31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31);
        $j_days_in_month = array(31, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, 29);
        ...
        if ($str == null) return $gy . '-' . $gms . '-' . $gds;
        else
            return $gy . $str . $gms . $str . $gds;
